...
testPlatformWrapper = \
  ...
  if [[ $$$$EXIT_CODE -eq 0 ]]; then \
    $(APPVEYORTOOL) UpdateTest -Name "$1" -Duration 1000 -Framework "MSTest" -FileName "" -Outcome Passed -StdOut $$$$STD_OUT; \
  else \
    $(APPVEYORTOOL) UpdateTest -Name "$1" -Duration 1000 -Framework "MSTest" -FileName "" -Outcome Failed -StdOut $$$$STD_OUT -StdErr $$$$STD_ERR; \
  fi; \
  exit $$$$EXIT_CODE;
