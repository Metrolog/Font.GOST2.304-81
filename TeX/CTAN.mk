...
$(eval $(call defineCTANRule,%.bat,$(LATEXPKG)/scripts/$(LATEXPKG)/%.bat))
$(eval $(call defineCTANRule,%.bbx,$(LATEXPKG)/tex/latex/$(LATEXPKG)/%.bbx))
$(eval $(call defineCTANRule,%.bib,$(LATEXPKG)/bibtex/bib/$(LATEXPKG)/%.bib))
$(eval $(call defineCTANRule,%.bst,$(LATEXPKG)/bibtex/bst/$(LATEXPKG)/%.bst))
$(eval $(call defineCTANRule,%.cbx,$(LATEXPKG)/tex/latex/$(LATEXPKG)/%.cbx))
$(eval $(call defineCTANRule,%.cls,$(LATEXPKG)/tex/latex/$(LATEXPKG)/%.cls))
$(eval $(call defineCTANRule,%.dbx,$(LATEXPKG)/tex/latex/$(LATEXPKG)/%.dbx))
$(eval $(call defineCTANRule,%.dtx,$(LATEXPKG)/source/%.dtx))
$(eval $(call defineCTANRule,%.dvi,$(LATEXPKG)/doc/%.dvi))
$(eval $(call defineCTANRule,%.fd,$(LATEXPKG)/tex/latex/$(LATEXPKG)/%.fd))
...
$(eval $(call defineCTANRule,%.mf,$(LATEXPKG)/fonts/source/public/$(LATEXPKG)/%.mf))
$(eval $(call defineCTANRule,%.mp,$(LATEXPKG)/metapost/$(LATEXPKG)/%.mp))
...
$(eval $(call defineCTANRule,%.py,$(LATEXPKG)/scripts/$(LATEXPKG)/%.py))
$(eval $(call defineCTANRule,%.sh,$(LATEXPKG)/scripts/$(LATEXPKG)/%.sh))
