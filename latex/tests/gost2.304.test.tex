...
\begin{document}
  ...
  \NewDocumentCommand \DrawChars {m O{20mm} } {
    \begin{tikzpicture}
    \papergraduate (-5mm,0mm) (160mm,#2);
  ...
  \newpage
  \eskdfont \eskdfontsize{7mm} \selectfont\mdseries
  \%, градусы и прочие "ненаклоняемые" символы в наклонных шрифтах
...

  {
    ...
    \DrawChars{aa\'aaa aa\"aaa aa\v{a}aa \r{a}}
    \DrawChars{\r{\Delta} \'\Delta \r{\delta}}
  }
