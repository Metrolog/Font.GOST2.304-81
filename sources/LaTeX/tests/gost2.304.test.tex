...
\begin{document}
...

  {
    ...
    \DrawChars{
      ...
      \addfontfeature{CharacterVariant={1}} 3
    }
  }
  {
    \eskdfontsize{14mm}
  ...
  \newcounter{digit}%
  {
    ...
    \DrawChars{%
      ...
      %\fontspec{GOST2.304-81TypeA-Regular.ttf} \addfontfeature{CharacterVariant={2}} \setcounter{digit}{5}\Roman{digit} 3
    }
  ...
  }
  {
    ...
    \DrawChars{%
      ...
      \setcounter{digit}{8}\Roman{digit}
      \setcounter{digit}{9}\Roman{digit}
      %\fontspec{GOST2.304-81TypeA-Slanted.ttf} \addfontfeature{CharacterVariant={2}} \setcounter{digit}{5}\Roman{digit} 3
    }
  }
